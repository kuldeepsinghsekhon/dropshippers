...
exports.forgetPasswordReset = function(req,res,next){
  ...
  { 
    ...
    var message= 'Please <a href="https://aquatecinnovative.herokuapp.com/sign-in/reset_password/?t='+token+'&id='+user._id+'"> Click Here </a> to reset Password <h3></h3><p> Your Validation Token is </p><h1>'+token+'</h1>'; 
    console.log(message);
    var mailOptions = {          
      from: 'aquatecinnovative1@gmail.com',
      to:email, //user.email,
